...
import "./App.css";
import { FaGithub, FaLinkedin, FaDownload, FaPython, FaChartBar, FaChartPie, FaChartLine, FaDatabase, FaRobot, FaExternalLinkAlt, FaFileExcel, FaCalculator, FaAward, FaUserFriends, FaSearch, FaTools } from "react-icons/fa";
      ...
      <Section id="skills">
        <div className="section-content skills-premium">
          ...
          <div className="skills-grid">
            ...
            <SkillCard name="EDA" percent="80" icon={FaSearch} />
