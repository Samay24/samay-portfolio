...
import "./App.css";
import { FaGithub, FaLinkedin, FaDownload, FaPython, FaChartBar, FaChartPie, FaChartLine, FaDatabase, FaRobot, FaExternalLinkAlt, FaFileExcel, FaCalculator, FaAward, FaUserFriends, FaSearch, FaTools, FaComments } from "react-icons/fa";
      ...
      <Section id="skills">
        <div className="section-content skills-premium">
          ...
          <div className="skills-grid">
            ...
            <SkillCard name="Data Storytelling" percent="85" icon={FaComments} />
